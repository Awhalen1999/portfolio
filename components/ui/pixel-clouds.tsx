...
const clouds: Cloud[] = [
  ...
  { id: 2, size: 'medium', version: 2, duration: 70, delay: 5, top: '18%' },
  { id: 3, size: 'large', version: 1, duration: 90, delay: 10, top: '12%' },
  { id: 4, size: 'small', version: 2, duration: 55, delay: 15, top: '28%' },
  { id: 5, size: 'xlarge', version: 1, duration: 100, delay: 20, top: '5%' },
  { id: 6, size: 'medium', version: 1, duration: 65, delay: 25, top: '38%' },
  { id: 7, size: 'small', version: 1, duration: 52, delay: 30, top: '48%' },
  { id: 8, size: 'large', version: 2, duration: 85, delay: 35, top: '35%' },
  { id: 9, size: 'medium', version: 2, duration: 68, delay: 40, top: '58%' },
  { id: 10, size: 'xlarge', version: 2, duration: 95, delay: 45, top: '52%' },
  { id: 11, size: 'small', version: 2, duration: 58, delay: 50, top: '68%' },
  { id: 12, size: 'large', version: 1, duration: 88, delay: 55, top: '62%' },
  { id: 13, size: 'medium', version: 1, duration: 72, delay: 60, top: '78%' },
  { id: 14, size: 'small', version: 1, duration: 60, delay: 65, top: '72%' },
  { id: 15, size: 'xlarge', version: 2, duration: 92, delay: 70, top: '85%' },
  { id: 16, size: 'small', version: 1, duration: 48, delay: 75, top: '15%' },
  { id: 17, size: 'medium', version: 2, duration: 73, delay: 80, top: '25%' },
  { id: 18, size: 'large', version: 1, duration: 87, delay: 85, top: '45%' },
  { id: 19, size: 'small', version: 2, duration: 53, delay: 90, top: '65%' },
  { id: 20, size: 'xlarge', version: 1, duration: 98, delay: 95, top: '75%' },
  { id: 21, size: 'medium', version: 1, duration: 66, delay: 100, top: '85%' },
  { id: 22, size: 'small', version: 1, duration: 51, delay: 105, top: '95%' },
  { id: 23, size: 'large', version: 2, duration: 84, delay: 110, top: '10%' },
  { id: 24, size: 'medium', version: 2, duration: 69, delay: 115, top: '30%' },
  { id: 25, size: 'xlarge', version: 2, duration: 96, delay: 120, top: '29%' },
]
